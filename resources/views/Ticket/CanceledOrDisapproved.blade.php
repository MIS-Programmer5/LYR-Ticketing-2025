        ...
        <div class="col-12">
          <div class="card card-custom gutter-b">
            ...
            <div class="col-12 col-sm-6 col-xxl-9 order-2 order-xxl-3 d-flex align-items-center justify-content-sm-end text-right my-2">
                ...
                <span onclick="getDiscontinuedTickets()" class="btn btn-default mr-2" data-toggle="tooltip" title="Reload list">
                  ...
                  <span class="btn btn-default" data-toggle="dropdown">
                   ...
                   @if (session()->get('user')->Permission_id == 1)
                        <div class="dropdown mr-2" data-toggle="tooltip" title="View">
                            ...
                            <div style="text-align: center" class="dropdown-menu dropdown-menu-right p-0 m-0 dropdown-menu-sm">
                                <ul class="navi py-3">
                                    <li class="navi-item">
                                        <a onclick="FilterData(1)" href="#" class="navi-link">
                                            <span class="navi-text">My Discontinued Task </span>
                                        </a>
                                    </li>
                                    <li class="navi-item">
                                        <a onclick="FilterData(2)" href="#" class="navi-link">
                                            <span class="navi-text">All Discontinued Task </span>
                                        </a>
                                    </li>
...
<script>
  ...
  function getDiscontinuedTickets(){
    let url=permission==1?'/api/get-cancel-disapproved/{{session()->get("user")->Department_id}}/0':'/api/get-cancel-disapproved/0/{{session()->get("user")->id}}';
    ...
    axios.get(url).then( response => {
      ...
      // console.log(response.data);
       if(permission == 1){
            ...
            data=filteredData;
            set_discontinued_list(filteredData,page,pageSize);
        }else{
            set_discontinued_list(data,page,pageSize);

        }
    //   set_closed_list(response.data);
    }).catch(function (error) { console.log(error) });
  }

  function set_discontinued_list(data = [],page,pageSize) {
...
function filterTickets(searchText) {
  ...
  set_discontinued_list(filteredTickets,page,pageSize);
}
